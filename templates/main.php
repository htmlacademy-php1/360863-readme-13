        ...
        <section class="authorization">
            ...
            <form class="authorization__form form" action="#" method="post">
                <div class="authorization__input-wrapper form__input-wrapper">
                    <div class="form__input-section <?=$errorLoginClass; ?>">
                        <input class="authorization__input authorization__input--login form__input" value="<?=$loginMain; ?>" type="text" name="login" placeholder="Логин">
                ...
                <div class="authorization__input-wrapper form__input-wrapper">
                    <div class="form__input-section <?=$errorPasswordClass; ?>">
                        <input class="authorization__input authorization__input--password form__input" value="<?=$passwordMain; ?>" type="password" name="password" placeholder="Пароль">
